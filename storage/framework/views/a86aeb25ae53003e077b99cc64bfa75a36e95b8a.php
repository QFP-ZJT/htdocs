<div></div>
<?php /*个人信息-查看业主信息*/ ?>
<table id='p_info_main' class="ui loading mainmain vertical center table ">
    <thead>
    <tr>
...
<?php /*个人信息-查看房屋信息*/ ?>
<table id='p_house_main' class="ui loading mainmain vertical center table">
    <thead>
    <tr>
...
<?php /*水价查询*/ ?>
<table id='price_main' class="ui loading mainmain vertical center table">
    <thead>
    <tr>
        <th class="two wide">编号</th>
        <th class="four wide">单价</th>
        <th class="four wide">单位</th>
